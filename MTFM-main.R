...
tags <- make.tags.fn(r2=r2,G0=,mydir=NA) # set mydir=NA if do not want to save tags to an Rdata file
...
bf <- BFexpanded.fn(ppbf,tags,t1snp.data,t1pheno,t2snp.data,t2pheno,trait1,trait2)
